...
const dados: Item[] = [
    ...
    {id: "9", nome: "Blade Storm", preco: "28,99", listaIngrediente: "Pão brioche azul, 2 hambúrgueres de carne bovina(150g), cebola caramelizada, cheddar, picles e bacon", image: require('./assets/images/burguer9.png')},
    {id: "10", nome: "Nebula", preco: "29,99", listaIngrediente: "Pão colorido, ", image: require('./assets/images/burguer10.png')},
